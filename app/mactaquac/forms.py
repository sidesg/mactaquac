...
class MediaFileSearchForm(forms.Form):
    ...
    accession = forms.CharField(label="accession", max_length=15, required=False)
...
class MediaFileFilterForm(forms.Form):
    ...
    accession = forms.CharField(label="accession", max_length=15, required=False, widget=forms.HiddenInput())
